<?php
/**
 * Neşeli Kaşifler - Ana Sayfa Template
 */
...
get_header(); ?>
    ...
    <section class="welcome-overlay">
        <div class="container">
            <div class="hero-welcome">
                <h1 class="hero-title">HOŞ GELDİNİZ</h1>
                <p class="hero-subtitle">Çocuğu Keşfet, Alemi Keşfet</p>
            </div>
        </div>
    </section>
    ...
    <section class="container">
        <div class="action-buttons">
            <a href="<?php echo esc_url( get_permalink( get_page_by_path( 'egitim-programlari' ) ) ); ?>" class="action-btn programs">
